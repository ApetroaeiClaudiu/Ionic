...
const movieUrl = `http://${baseUrl}/movieManagement/api/movies`;
...
export const removeMovie: (movie: MovieProps) => void = movie => {
    return withLogs(axios.delete(`${movieUrl}/${movie.id}`,config),'removeMovie');
}
